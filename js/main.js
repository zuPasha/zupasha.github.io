...
// ============================================================
// Grid and gallery thumbnails load from images/portfolio/thumbs/...
// instead of the full-resolution file, generated by make_thumbnails.py.
// The lightbox still uses the original full-resolution src directly,
// this helper is only ever applied to the small grid/gallery <img>s.
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (screenshotContainer && typeof IMAGE_DATA !== 'undefined') {
    ...
    screenshots.forEach(img => {
      ...
      item.innerHTML = `
        <img src="${toThumbSrc(img.src)}" alt="${img.alt || ''}" loading="lazy" decoding="async"
